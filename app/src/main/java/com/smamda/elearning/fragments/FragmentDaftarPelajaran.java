 ...
 */
public class FragmentDaftarPelajaran extends Fragment {
    ...
    public FragmentDaftarPelajaran() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_daftar_pelajaran, container, false);
    ...
    private void setupToolbar(){
        toolbar.setTitle(getString(R.string.daftar_pelajaran_fragment_title));
